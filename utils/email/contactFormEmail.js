...
// send tenant contact form email to specific users
...
// send landlord contact form email to specific users

const sendLandlordContactFormEmail = async (contactFormInfo) => {
  const subject = `New Contact Form Landlord`;
      ...
      <body>
        <div class="container">
          <div class="header">
            ...
            <h1 class="title">Contact Us Form For Landlord</h1>
          </div>
          <div class="content">
            <h2 class="info-label">Full Name:</h2>
            <p class="info-value">${contactFormInfo.fullName}</p>
            ...
            <p class="info-label">Message:</p>
            <p class="info-value">${contactFormInfo.landlordMessage}</p>
            
            <p class="info-label">Email:</p>
            <p class="info-value">${contactFormInfo.landlordEmail}</p>
            
            <p class="info-label">Phone Number:</p>
            <p class="info-value">${contactFormInfo.landlordPhoneNo}</p>

            <p class="info-label">Package:</p>
            <p class="info-value">${contactFormInfo.package}</p>

            <p class="info-label">Portfolio Size:</p>
            <p class="info-value">${contactFormInfo.portfolioSize}</p>

            <p class="info-label">Post Code:</p>
            <p class="info-value">${contactFormInfo.postCode}</p>
